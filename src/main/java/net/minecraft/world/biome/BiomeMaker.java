...
public class BiomeMaker {
   ...
   public static Biome makeEndMidlandsBiome() {
      BiomeGenerationSettings.Builder biomegenerationsettings$builder = (new BiomeGenerationSettings.Builder()).withSurfaceBuilder(ConfiguredSurfaceBuilders.field_244173_e).withStructure(StructureFeatures.END_CITY);
      return makeEndBiome(biomegenerationsettings$builder);
   }

   public static Biome makeEndHighlandsBiome() {
      BiomeGenerationSettings.Builder biomegenerationsettings$builder = (new BiomeGenerationSettings.Builder()).withSurfaceBuilder(ConfiguredSurfaceBuilders.field_244173_e).withStructure(StructureFeatures.END_CITY).withFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, Features.END_GATEWAY).withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Features.CHORUS_PLANT);
      return makeEndBiome(biomegenerationsettings$builder);
   }
   ...
   private static Biome makeGenericSavannaBiome(float depth, float scale, float temperature, boolean isHighland, boolean isShatteredSavanna, MobSpawnInfo.Builder mobSpawnBuilder) {
      ...
      if (!isHighland && !isShatteredSavanna) {
         biomegenerationsettings$builder.withStructure(StructureFeatures.VILLAGE_SAVANNA).withStructure(StructureFeatures.PILLAGER_OUTPOST);
      }

      DefaultBiomeFeatures.withStrongholdAndMineshaft(biomegenerationsettings$builder);
      biomegenerationsettings$builder.withStructure(isHighland ? StructureFeatures.RUINED_PORTAL_MOUNTAIN : StructureFeatures.RUINED_PORTAL);
      DefaultBiomeFeatures.withCavesAndCanyons(biomegenerationsettings$builder);
      DefaultBiomeFeatures.withLavaAndWaterLakes(biomegenerationsettings$builder);
      DefaultBiomeFeatures.withMonsterRoom(biomegenerationsettings$builder);
   ...
   public static Biome makeTaigaBiome(float depth, float scale, boolean isSnowyVariant, boolean isMountainVariant, boolean hasVillageAndOutpost, boolean hasIgloos) {
      ...
      DefaultBiomeFeatures.withStrongholdAndMineshaft(biomegenerationsettings$builder);
      biomegenerationsettings$builder.withStructure(isMountainVariant ? StructureFeatures.RUINED_PORTAL_MOUNTAIN : StructureFeatures.RUINED_PORTAL);
      DefaultBiomeFeatures.withCavesAndCanyons(biomegenerationsettings$builder);
      DefaultBiomeFeatures.withLavaAndWaterLakes(biomegenerationsettings$builder);
      DefaultBiomeFeatures.withMonsterRoom(biomegenerationsettings$builder);
      DefaultBiomeFeatures.withLargeFern(biomegenerationsettings$builder);
   ...
   public static Biome makeSnowyBiome(float depth, float scale, boolean isIceSpikesBiome, boolean isMountainVariant) {
      ...
      if (!isIceSpikesBiome && !isMountainVariant) {
         biomegenerationsettings$builder.withStructure(StructureFeatures.VILLAGE_SNOWY).withStructure(StructureFeatures.IGLOO);
      }
   ...
   public static Biome makeGenericBeachBiome(float depth, float scale, float temperature, float downfall, int waterColor, boolean isColdBiome, boolean isStoneVariant) {
      ...
      biomegenerationsettings$builder.withStructure(isStoneVariant ? StructureFeatures.RUINED_PORTAL_MOUNTAIN : StructureFeatures.RUINED_PORTAL);
      DefaultBiomeFeatures.withCavesAndCanyons(biomegenerationsettings$builder);
      DefaultBiomeFeatures.withLavaAndWaterLakes(biomegenerationsettings$builder);
      DefaultBiomeFeatures.withMonsterRoom(biomegenerationsettings$builder);
      DefaultBiomeFeatures.withCommonOverworldBlocks(biomegenerationsettings$builder);
   ...
   public static Biome makeNetherWastesBiome() {
      ...
      BiomeGenerationSettings.Builder biomegenerationsettings$builder = (new BiomeGenerationSettings.Builder()).withSurfaceBuilder(ConfiguredSurfaceBuilders.field_244183_o).withStructure(StructureFeatures.RUINED_PORTAL_NETHER).withStructure(StructureFeatures.FORTRESS).withStructure(StructureFeatures.BASTION_REMNANT).withCarver(GenerationStage.Carving.AIR, ConfiguredCarvers.field_243772_f).withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Features.SPRING_LAVA);
      DefaultBiomeFeatures.withNormalMushroomGeneration(biomegenerationsettings$builder);
   ...
   public static Biome makeCrimsonForestBiome() {
      ...
      BiomeGenerationSettings.Builder biomegenerationsettings$builder = (new BiomeGenerationSettings.Builder()).withSurfaceBuilder(ConfiguredSurfaceBuilders.field_244171_c).withStructure(StructureFeatures.RUINED_PORTAL_NETHER).withCarver(GenerationStage.Carving.AIR, ConfiguredCarvers.field_243772_f).withStructure(StructureFeatures.FORTRESS).withStructure(StructureFeatures.BASTION_REMNANT).withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Features.SPRING_LAVA);
      DefaultBiomeFeatures.withNormalMushroomGeneration(biomegenerationsettings$builder);
