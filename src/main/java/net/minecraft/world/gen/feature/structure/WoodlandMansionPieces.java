   ...
   public static class MansionTemplate extends TemplateStructurePiece {
      ...
      protected void handleDataMarker(String function, BlockPos pos, IServerWorld worldIn, Random rand, MutableBoundingBox sbb) {
         if (function.startsWith("Chest")) {
            ...
            abstractillagerentity.onInitialSpawn(worldIn, worldIn.getDifficultyForLocation(abstractillagerentity.getPosition()), SpawnReason.STRUCTURE, (ILivingEntityData)null, (CompoundNBT)null);
