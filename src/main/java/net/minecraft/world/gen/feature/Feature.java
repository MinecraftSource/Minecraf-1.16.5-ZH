...
public abstract class Feature<FC extends IFeatureConfig> {
   ...
   public static final Feature<BlobReplacementConfig> NETHERRACK_REPLACE_BLOBS = register("netherrack_replace_blobs", new NetherackBlobReplacementStructure(BlobReplacementConfig.CODEC));
