...
public abstract class AbstractFeatureSizeType {
   public static final Codec<AbstractFeatureSizeType> CODEC = Registry.FEATURE_SIZE_TYPE.dispatch(AbstractFeatureSizeType::func_230370_b_, FeatureSizeType::getCodec);
