...
public class IcebergFeature extends Feature<BlockStateFeatureConfig> {
   ...
   public boolean generate(ISeedReader reader, ChunkGenerator generator, Random rand, BlockPos pos, BlockStateFeatureConfig config) {
      pos = new BlockPos(pos.getX(), generator.getSeaLevel(), pos.getZ());
      ...
      for(int l1 = -k1; l1 < k1; ++l1) {
         for(int i2 = -k1; i2 < k1; ++i2) {
            for(int j2 = 0; j2 < l; ++j2) {
               int k2 = flag1 ? this.func_205178_b(j2, l, j1) : this.func_205183_a(rand, j2, l, j1);
               if (flag1 || l1 < k2) {
                  this.func_205181_a(reader, rand, pos, l, l1, j2, i2, k2, k1, flag1, j, d0, flag, blockstate);
               }
            }
         }
      }

      this.func_205186_a(reader, pos, j1, l, flag1, i);
      ...
      for(int i3 = -k1; i3 < k1; ++i3) {
         for(int j3 = -k1; j3 < k1; ++j3) {
            for(int k3 = -1; k3 > -i1; --k3) {
               ...
               int l2 = this.func_205187_b(rand, -k3, i1, j1);
               if (i3 < l2) {
                  this.func_205181_a(reader, rand, pos, i1, i3, k3, j3, l2, l3, flag1, j, d0, flag, blockstate);
               }
            }
         }
      }
      ...
      if (flag2) {
         this.func_205184_a(rand, reader, j1, l, pos, flag1, i, d0, j);
      }
