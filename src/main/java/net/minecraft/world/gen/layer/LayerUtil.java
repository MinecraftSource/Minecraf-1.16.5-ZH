...
public class LayerUtil {
   private static final Int2IntMap field_242937_a = Util.make(new Int2IntOpenHashMap(), (p_242938_0_) -> {
      ...
      func_242939_a(p_242938_0_, LayerUtil.Type.OCEAN, 46);
      func_242939_a(p_242938_0_, LayerUtil.Type.OCEAN, 49);
      func_242939_a(p_242938_0_, LayerUtil.Type.OCEAN, 50);
      func_242939_a(p_242938_0_, LayerUtil.Type.OCEAN, 48);
      func_242939_a(p_242938_0_, LayerUtil.Type.OCEAN, 24);
      func_242939_a(p_242938_0_, LayerUtil.Type.OCEAN, 47);
      func_242939_a(p_242938_0_, LayerUtil.Type.OCEAN, 10);
      func_242939_a(p_242938_0_, LayerUtil.Type.OCEAN, 45);
      func_242939_a(p_242938_0_, LayerUtil.Type.OCEAN, 0);
      func_242939_a(p_242938_0_, LayerUtil.Type.OCEAN, 44);
   ...
   private static void func_242939_a(Int2IntOpenHashMap p_242939_0_, LayerUtil.Type p_242939_1_, int p_242939_2_) {
