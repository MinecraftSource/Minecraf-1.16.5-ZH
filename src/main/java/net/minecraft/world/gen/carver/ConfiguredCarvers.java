...
public class ConfiguredCarvers {
   ...
   public static final ConfiguredCarver<ProbabilityConfig> field_243772_f = func_243773_a("nether_cave", WorldCarver.NETHER_CAVE.func_242761_a(new ProbabilityConfig(0.2F)));
