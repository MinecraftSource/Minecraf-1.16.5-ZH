...
public class BlockModelRenderer {
   ...
   public static enum NeighborInfo {
      ...
      private static final BlockModelRenderer.NeighborInfo[] VALUES = Util.make(new BlockModelRenderer.NeighborInfo[6], (array) -> {
   ...
   static enum VertexTranslations {
      ...
      private static final BlockModelRenderer.VertexTranslations[] VALUES = Util.make(new BlockModelRenderer.VertexTranslations[6], (array) -> {
         array[Direction.DOWN.getIndex()] = DOWN;
         array[Direction.UP.getIndex()] = UP;
         array[Direction.NORTH.getIndex()] = NORTH;
         array[Direction.SOUTH.getIndex()] = SOUTH;
