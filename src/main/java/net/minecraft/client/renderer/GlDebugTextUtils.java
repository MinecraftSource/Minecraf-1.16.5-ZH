...
public class GlDebugTextUtils {
   ...
   private static void logDebugMessage(int source, int type, int id, int severity, int messageLength, long message, long p_209244_7_) {
      LOGGER.info("OpenGL debug message, id={}, source={}, type={}, severity={}, message={}", id, getSource(source), getType(type), getSeverity(severity), GLDebugMessageCallback.getMessage(messageLength, message));
   }

   private static void registerGlConstantName(int value, String name) {
      GL_CONSTANT_NAMES.merge(value, name, (p_209249_0_, p_209249_1_) -> {
         return p_209249_0_ + "/" + p_209249_1_;
      });
   }
