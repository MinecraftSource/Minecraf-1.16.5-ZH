...
public class BoarModel<T extends MobEntity & IFlinging> extends AgeableModel<T> {
   ...
   public void setRotationAngles(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      this.field_239107_b_.rotateAngleZ = -0.6981317F - limbSwingAmount * MathHelper.sin(limbSwing);
      this.field_239108_f_.rotateAngleZ = 0.6981317F + limbSwingAmount * MathHelper.sin(limbSwing);
