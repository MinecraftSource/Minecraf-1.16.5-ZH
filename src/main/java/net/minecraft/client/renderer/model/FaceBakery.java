...
public class FaceBakery {
   ...
   private void fillVertexData(int[] vertexData, int vertexIndex, Vector3f vector, TextureAtlasSprite sprite, BlockFaceUV blockFaceUV) {
      ...
      vertexData[i + 3] = -1;
      vertexData[i + 4] = Float.floatToRawIntBits(sprite.getInterpolatedU((double)blockFaceUV.getVertexU(vertexIndex)));
      vertexData[i + 4 + 1] = Float.floatToRawIntBits(sprite.getInterpolatedV((double)blockFaceUV.getVertexV(vertexIndex)));
   }
