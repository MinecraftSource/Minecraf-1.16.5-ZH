...
public class FilterListEntry extends AbstractOptionList.Entry<FilterListEntry> {
   ...
   public FilterListEntry(Minecraft p_i244722_1_, SocialInteractionsScreen p_i244722_2_, UUID p_i244722_3_, String p_i244722_4_, Supplier<ResourceLocation> p_i244722_5_) {
      ...
      this.field_244628_m = p_i244722_1_.fontRenderer.trimStringToWidth(new TranslationTextComponent("gui.socialInteractions.tooltip.hide", p_i244722_4_), 150);
      this.field_244629_n = p_i244722_1_.fontRenderer.trimStringToWidth(new TranslationTextComponent("gui.socialInteractions.tooltip.show", p_i244722_4_), 150);
      ...
      if (!p_i244722_1_.player.getGameProfile().getId().equals(p_i244722_3_) && !filtermanager.func_244757_e(p_i244722_3_)) {
         ...
         this.field_244627_l.visible = filtermanager.func_244648_c(p_i244722_3_);
