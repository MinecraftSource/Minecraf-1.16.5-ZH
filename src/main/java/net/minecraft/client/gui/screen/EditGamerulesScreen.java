...
public class EditGamerulesScreen extends Screen {
   ...
   public class NameEntry extends EditGamerulesScreen.Gamerule {
      ...
      public void render(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_) {
         AbstractGui.drawCenteredString(p_230432_1_, EditGamerulesScreen.this.minecraft.fontRenderer, this.field_238994_c_, p_230432_4_ + p_230432_5_ / 2, p_230432_3_ + 5, 16777215);
      }
   ...
   public abstract class ValueEntry extends EditGamerulesScreen.Gamerule {
      ...
      protected void func_241649_a_(MatrixStack p_241649_1_, int p_241649_2_, int p_241649_3_) {
         if (this.field_241646_a_.size() == 1) {
            EditGamerulesScreen.this.minecraft.fontRenderer.func_238422_b_(p_241649_1_, this.field_241646_a_.get(0), (float)p_241649_3_, (float)(p_241649_2_ + 5), 16777215);
         } else if (this.field_241646_a_.size() >= 2) {
            EditGamerulesScreen.this.minecraft.fontRenderer.func_238422_b_(p_241649_1_, this.field_241646_a_.get(0), (float)p_241649_3_, (float)p_241649_2_, 16777215);
            EditGamerulesScreen.this.minecraft.fontRenderer.func_238422_b_(p_241649_1_, this.field_241646_a_.get(1), (float)p_241649_3_, (float)(p_241649_2_ + 10), 16777215);
         }
