...
public class FontRenderer {
   ...
   public FontRenderer(Function<ResourceLocation, Font> font) {
      this.font = font;
      this.characterManager = new CharacterManager((p_238404_1_, p_238404_2_) -> {
         return this.getFont(p_238404_2_.getFontId()).func_238557_a_(p_238404_1_).getAdvance(p_238404_2_.getBold());
      });
   }
   ...
   public String func_238413_a_(String p_238413_1_, int p_238413_2_, boolean p_238413_3_) {
      return p_238413_3_ ? this.characterManager.func_238364_c_(p_238413_1_, p_238413_2_, Style.EMPTY) : this.characterManager.func_238361_b_(p_238413_1_, p_238413_2_, Style.EMPTY);
   }

   public String func_238412_a_(String p_238412_1_, int p_238412_2_) {
      return this.characterManager.func_238361_b_(p_238412_1_, p_238412_2_, Style.EMPTY);
   }
