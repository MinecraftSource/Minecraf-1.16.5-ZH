...
public class IngameGui extends AbstractGui {
   ...
   public void func_238454_b_(MatrixStack p_238454_1_, int p_238454_2_) {
      ...
      if (this.mc.player.experienceLevel > 0) {
         ...
         this.getFontRenderer().drawString(p_238454_1_, s, (float)(i1 + 1), (float)j1, 0);
         this.getFontRenderer().drawString(p_238454_1_, s, (float)(i1 - 1), (float)j1, 0);
         this.getFontRenderer().drawString(p_238454_1_, s, (float)i1, (float)(j1 + 1), 0);
         this.getFontRenderer().drawString(p_238454_1_, s, (float)i1, (float)(j1 - 1), 0);
         this.getFontRenderer().drawString(p_238454_1_, s, (float)i1, (float)j1, 8453920);
         this.mc.getProfiler().endSection();
      }
   ...
   public void func_238453_b_(MatrixStack p_238453_1_) {
      ...
      if (this.remainingHighlightTicks > 0 && !this.highlightingItemStack.isEmpty()) {
         ...
         int i = this.getFontRenderer().getStringPropertyWidth(iformattabletextcomponent);
         ...
         if (l > 0) {
            ...
            this.getFontRenderer().func_243246_a(p_238453_1_, iformattabletextcomponent, (float)j, (float)k, 16777215 + (l << 24));
            RenderSystem.disableBlend();
            RenderSystem.popMatrix();
         }
      }
   ...
   public void func_238450_a_(ChatType p_238450_1_, ITextComponent p_238450_2_, UUID p_238450_3_) {
      if (!this.mc.cannotSendChatMessages(p_238450_3_)) {
         if (!this.mc.gameSettings.field_244794_ae || !this.mc.cannotSendChatMessages(this.func_244795_b(p_238450_2_))) {
