...
public class RealmsSubscriptionInfoScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.addButton(new Button(this.width / 2 - 100, func_239562_k_(6), 200, 20, new TranslationTextComponent("mco.configure.world.subscription.extend"), (p_238073_1_) -> {
         String s = "https://aka.ms/ExtendJavaRealms?subscriptionId=" + this.field_224581_c.field_230583_b_ + "&profileId=" + this.minecraft.getSession().getPlayerID();
         this.minecraft.keyboardListener.setClipboardString(s);
      ...
      if (this.field_224581_c.field_230591_j_) {
         this.addButton(new Button(this.width / 2 - 100, func_239562_k_(10), 200, 20, new TranslationTextComponent("mco.configure.world.delete.button"), (p_238069_1_) -> {
            ...
            this.minecraft.displayGuiScreen(new RealmsLongConfirmationScreen(this::func_238074_c_, RealmsLongConfirmationScreen.Type.Warning, itextcomponent, itextcomponent1, true));
         }));
      }
         ...
         (new Thread("Realms-delete-realm") {
            public void run() {
               ...
               RealmsSubscriptionInfoScreen.this.minecraft.execute(() -> {
                  RealmsSubscriptionInfoScreen.this.minecraft.displayGuiScreen(RealmsSubscriptionInfoScreen.this.field_224582_d);
               });
            }
         }).start();
      }
