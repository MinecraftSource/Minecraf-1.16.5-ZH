...
public class RealmsResetWorldScreen extends NotifableRealmsScreen {
   ...
   private void func_237948_a_(MatrixStack p_237948_1_, int p_237948_2_, int p_237948_3_, ITextComponent p_237948_4_, ResourceLocation p_237948_5_, boolean p_237948_6_, boolean p_237948_7_) {
      this.minecraft.getTextureManager().bindTexture(p_237948_5_);
      if (p_237948_6_) {
   ...
   public void func_237952_a_(Runnable p_237952_1_) {
      this.minecraft.displayGuiScreen(new RealmsLongRunningMcoTaskScreen(this.field_224457_c, new SwitchMinigameRealmsAction(this.field_224458_d.field_230582_a_, this.field_224455_a, p_237952_1_)));
   }
   ...
   private void func_237953_a_(@Nullable String p_237953_1_, @Nullable WorldTemplate p_237953_2_, int p_237953_3_, boolean p_237953_4_) {
      this.minecraft.displayGuiScreen(new RealmsLongRunningMcoTaskScreen(this.field_224457_c, new ResetWorldRealmsAction(p_237953_1_, p_237953_2_, p_237953_3_, p_237953_4_, this.field_224458_d.field_230582_a_, this.field_224475_u, this.field_237942_L_)));
   }
